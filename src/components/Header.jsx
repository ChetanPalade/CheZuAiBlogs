...
export default function Header({isSignup,setisSignup}) {
  ...
  return (
    <AppBar position='sticky' sx={{background:"linear-gradient(to right, rgba(255,1,1,1) 10%, rgba(0,129,255,1) 49%, rgba(6,35,41,1) 99%)"}}>
        <Toolbar>
          <Typography variant="h4">CheZuAIBlogs</Typography>
